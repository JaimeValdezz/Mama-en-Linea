...
<style>
    ...
    .hero-section {
        background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), 
                    url('<?php echo e(asset("images/hero-home.jpg")); ?>');
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <div class="card nav-card p-4 text-center">
                ...
                <a href="<?php echo e(route('vacantes.index')); ?>" class="btn-acceso">Ver Vacantes</a>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card nav-card p-4 text-center">
                ...
                <a href="<?php echo e(route('apoyos.psicologicos')); ?>" class="btn-acceso">Solicitar Apoyo</a>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card nav-card p-4 text-center">
                ...
                <a href="<?php echo e(route('apoyos.gubernamentales')); ?>" class="btn-acceso">Ver Programas</a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\web3\dev\resources\views/home.blade.php ENDPATH**/ ?>