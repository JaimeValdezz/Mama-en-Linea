...
<style>
    ...
    /* Estilo para el botón de publicar (lo mantenemos para la empresa) */
    .btn-postular-lila {
...
<div class="container mt-4">
    {{-- 1. Botón para empresas: Se mantiene para que puedan crear contenido --}}
            ...
            <div class="col-md-4">
                <div class="vacante-card shadow-sm">
                    ...
                    <div class="p-4">
                        ...
                        {{-- Pie de la tarjeta: Botón eliminado, solo icono de favorito a la derecha --}}
